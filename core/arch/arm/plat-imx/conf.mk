...
CFG_CORE_ASYNC_NOTIF_INTID ?= 122
endif
...
CFG_SEC_RAM_SIZE ?= 0x02000000 # 32MB
CFG_SHMEM_SIZE ?= 0x00200000 # 2MB
CFG_TZDRAM_SIZE ?= $(CFG_SEC_RAM_SIZE) - $(CFG_SHMEM_SIZE)
CFG_TZDRAM_START ?= ($(CFG_DRAM_BASE) - $(CFG_SEC_RAM_SIZE) + $(CFG_DDR_SIZE))
CFG_SHMEM_START ?= ($(CFG_TZDRAM_START) + $(CFG_TZDRAM_SIZE))

CFG_NSEC_DDR_0_BASE ?= $(CFG_DRAM_BASE)
CFG_NSEC_DDR_0_SIZE ?= ($(CFG_DDR_SIZE) - $(CFG_SEC_RAM_SIZE))
...
CFG_TEE_RAM_VA_SIZE ?= 0x00c00000 # 12 MB